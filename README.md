...
My Brain AI is a local learning assistant that lets users upload PDF or TXT files, teach memories, correct answers, and ask questions with source snippets returned from the learned knowledge base.
